        ...
        <div class="bg-white rounded-xl p-8 max-w-2xl w-full mx-4">
            ...
            <form action="send_message.php" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="message" id="messageInput" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary" rows="4" placeholder="Type your message here..."></textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <label class="flex items-center">
                            ...
                            <span>Email</span>
                            <span class="text-red-500 text-xs ml-1 recipient-email-warning hidden">(No email available)</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="message_type" value="sms" class="mr-2" id="smsOption">
                            <span>SMS</span>
                            <span class="text-red-500 text-xs ml-1 recipient-phone-warning hidden">(No phone available)</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="message_type" value="both" class="mr-2" id="bothOption">
                            <span>Email & SMS</span>
                            <span class="text-red-500 text-xs ml-1 recipient-contact-warning hidden">(Missing contact info)</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4 mt-6">
                    <button type="button" id="previewButton" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
...
const messageInput = document.querySelector('[name="message"]');
            ...
            recipientSelect.addEventListener('change', function() {
                ...
                document.querySelectorAll('.recipient-contact-warning').forEach(el => {
                    el.classList.toggle('hidden', (email !== null && email !== '') && (phone !== null && phone !== ''));
                });
            ...
            previewButton.addEventListener('click', function() {
                ...
                if (selectedType === 'email' || selectedType === 'both') {
                    ...
                    previewEmailTo.textContent = recipient.getAttribute('data-email') || 'No email available';
                ...
                if (selectedType === 'sms' || selectedType === 'both') {
                    ...
                    const remainingChars = 160 - smsText.length - 30; // 30 chars for "... Reply in your landlord portal."
