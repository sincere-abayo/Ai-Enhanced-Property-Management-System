        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                ...
                <p class="text-gray-600">
                    Conversation with <?php echo htmlspecialchars($otherParticipant['first_name'] . ' ' . $otherParticipant['last_name']); ?>
                </p>
            </div>
        </div>
            ...
            <div class="space-y-6">
                <?php foreach ($messages as $message): ?>
                    <div class="flex <?php echo $message['sender_id'] == $userId ? 'justify-end' : 'justify-start'; ?>">
                        <div class="<?php echo $message['sender_id'] == $userId ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'; ?> rounded-lg px-4 py-3 max-w-md">
                            <div class="flex items-center mb-1">
                                <?php if ($message['sender_id'] != $userId): ?>
                                    <div class="flex-shrink-0 h-8 w-8 mr-2">
                                        <img class="h-8 w-8 rounded-full" src="https://ui-avatars.com/api/?name=<?php echo urlencode($message['first_name'] . '+' . $message['last_name']); ?>&background=random" alt="User">
                                    </div>
                                <?php endif; ?>
                                <div>
