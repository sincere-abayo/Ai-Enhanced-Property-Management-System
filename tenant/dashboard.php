...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Welcome back, <?php echo htmlspecialchars($firstName); ?>!
                </h2>
                ...
                <div>
                    <div class="relative ml-3">
                        ...
                        <div id="notificationDropdown"
                            class="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-1 z-10">
                            <div class="px-4 py-2 border-b border-gray-200">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-sm font-semibold text-gray-700">Notifications</h3>
                                    <?php if ($unreadNotificationsCount > 0): ?>
                                    <a href="#" id="markAllReadBtn"
                                        class="text-xs text-primary hover:text-blue-700">Mark all as read</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            ?>
                                ...
                                <a href="view_notification.php?id=<?php echo $notification['notification_id']; ?>"
                                    class="block px-4 py-2 hover:bg-gray-200 <?php echo $notification['is_read'] ? '' : 'bg-blue-50'; ?>">
                                    <div class="flex items-start">
                                        ...
                                        <div class="rounded-lg ml-3">
                                            <p class="text-sm font-medium text-gray-900">
                                                <?php echo htmlspecialchars(mb_strimwidth($notification['title'], 0, 30, "...")); ?>
                                            </p>
                                            <p class="text-xs text-gray-500 truncate">
                                                <?php echo htmlspecialchars(mb_strimwidth($notification['message'], 0, 20, "...")); ?>
                                            </p>
                                            <p class="text-xs text-gray-400 mt-1">
                                                <?php echo timeAgo($notification['created_at']); ?></p>
                                        </div>
                                    </div>
                                </a>
                                <?php endforeach; ?>
                            ...
                            <div class="px-4 py-2 border-t border-gray-200">
                                <a href="notifications.php"
                                    class="block text-center text-sm text-primary hover:text-blue-700">
        ...
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-8">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm">You don't have any active leases. Please contact your property manager for
                        assistance.</p>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-4xl w-full mx-4">
                <div class="relative">
                    ...
                    <button onclick="closeImageModal()"
                        class="absolute top-2 right-2 text-white bg-black bg-opacity-50 rounded-full w-8 h-8 flex items-center justify-center">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                    ...
                    <p class="text-xl font-semibold" data-currency-value="<?= $nextPayment['amount'] ?>"
                        data-currency-original="USD"><?php echo convertAndFormat($nextPayment['amount']); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        <span
                            class="px-2 py-1 text-xs font-medium rounded-full <?php echo $request['status_class']; ?>">
                ...
                <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium">
                            Payment of <span data-currency-value="<?= $payment['amount'] ?>"
                                data-currency-original="USD"> <?php echo formatCurrency($payment['amount']); ?> </span>
                            recorded
                        </p>
                        <p class="text-xs text-gray-500">
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                const badge = document.querySelector(
                                    '.absolute.top-0.right-0.inline-flex');
                                if (badge) {
                                    badge.remove();
                                }
