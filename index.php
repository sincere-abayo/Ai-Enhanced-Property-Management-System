...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-md">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="#properties" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Properties
                        </a>
        ...
        <div class="sm:hidden hidden mobile-menu">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="#properties" class="text-gray-500 hover:bg-gray-50 hover:text-gray-700 block pl-3 pr-4 py-2 text-base font-medium">
                    Properties
                </a>
                <a href="#contact" class="text-gray-500 hover:bg-gray-50 hover:text-gray-700 block pl-3 pr-4 py-2 text-base font-medium">
                    Contact
                </a>
                <a href="login.php" class="text-gray-500 hover:bg-gray-50 hover:text-gray-700 block pl-3 pr-4 py-2 text-base font-medium">
                    Login
                </a>
    ...
    <section class="hero-section flex items-center justify-center">
        <div class="text-center text-white px-4">
            ...
            <a href="#properties" class="bg-primary text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-blue-700 transition duration-300">
                View Properties
            </a>
        </div>
    </section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select name="property_type" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary">
                                ...
                                <option value="<?php echo $type; ?>" <?php echo $propertyType === $type ? 'selected' : ''; ?>>
                        ...
                        <div>
                            ...
                            <select name="price_range" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary">
                                ...
                                <option value="1001-2000" <?php echo $priceRange === '1001-2000' ? 'selected' : ''; ?>>$1001 - $2000</option>
                                <option value="2001+" <?php echo $priceRange === '2001+' ? 'selected' : ''; ?>>$2001+</option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div class="bg-white rounded-xl shadow-md overflow-hidden property-card" 
                            ...
                            <div class="relative">
                                <?php if (!empty($property['image_path'])): ?>
                                    <img src="<?php echo htmlspecialchars($property['image_path']); ?>" alt="<?php echo htmlspecialchars($property['property_name']); ?>" class="w-full h-48 object-cover property-image">
                                <?php else: ?>
                                    <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Property" class="w-full h-48 object-cover property-image">
                                <?php endif; ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold capitalize"><?php echo $property['property_type']; ?></p>
                                    </div>
                                </div>
                                <div class="flex space-x-2">
                                    <button class="flex-1 bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-center view-details-btn">
                                        View Details
                                    </button>
                                    <button class="flex-1 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 text-center inquire-btn">
                                        Inquire Now
                                    </button>
                                </div>
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-gray-600">We offer a wide selection of high-quality properties in prime locations to meet your needs.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    <div class="text-primary text-4xl mb-4">
                    ...
                    <p class="text-gray-600">Our rental rates are competitive and transparent, with no hidden fees or charges.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    <div class="text-primary text-4xl mb-4">
                    ...
                    <p class="text-gray-600">Our dedicated team provides responsive support for all your property-related needs.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="bg-gray-100 rounded-xl overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-8">
                        ...
                        <p class="text-gray-600 mb-6">Have questions about our properties or services? Fill out the form and we'll get back to you as soon as possible.</p>
                        ...
                        <form method="POST" action="#contact" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" required class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary">
                            </div>
                            
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                <input type="email" id="email" name="email" required class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary">
                            </div>
                            
                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                                <input type="tel" id="phone" name="phone" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary">
                            </div>
                            
                            <div>
                                <label for="property_interest" class="block text-sm font-medium text-gray-700 mb-1">Property of Interest</label>
                                <input type="text" id="property_interest" name="property_interest" readonly class="w-full rounded-lg bg-gray-50 border-gray-300">
                            </div>
                            
                            <div>
                                <label for="message" class="block text-sm font-medium text-gray-700 mb-1">Message</label>
                                <textarea id="message" name="message" rows="4" required class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring-primary"></textarea>
                            </div>
                            
                            <div>
                                <button type="submit" name="contact_submit" class="w-full bg-primary text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-blue-700 transition duration-300">
                                    Send Message
                                </button>
                            </div>
                        </form>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="?property_type=apartment" class="text-gray-400 hover:text-white">Apartments</a></li>
                        ...
                        <li><a href="?property_type=commercial" class="text-gray-400 hover:text-white">Commercial</a></li>
                    </ul>
                </div>
    ...
    <div id="propertyModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-xl p-6 max-w-4xl w-full mx-4 max-h-90vh overflow-y-auto">
            ...
            <div class="flex space-x-4">
                <button id="modalInquireBtn" class="flex-1 bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-center">
            ...
            fetch(`api/get_property.php?id=${propertyId}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('modalPropertyType').textContent = property.property_type.charAt(0).toUpperCase() + property.property_type.slice(1);
                        ...
                        document.getElementById('modalSquareFeet').textContent = property.square_feet ? `${property.square_feet} sq ft` : '-';
                        document.getElementById('modalRent').textContent = `$${parseFloat(property.monthly_rent).toFixed(2)}`;
                        document.getElementById('modalAddress').textContent = `${property.address}, ${property.city}, ${property.state} ${property.zip_code}`;
                        document.getElementById('modalStatus').textContent = property.status.charAt(0).toUpperCase() + property.status.slice(1);
                        ...
                        mainImageElement.src = property.image_path || 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80';
                        ...
                        mainThumbnail.className = 'w-20 h-20 flex-shrink-0 rounded overflow-hidden cursor-pointer border-2 border-primary';
                        mainThumbnail.innerHTML = `<img src="${property.image_path || 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'}" alt="${property.property_name}" class="w-full h-full object-cover">`;
                        ...
                        if (property.additional_images && property.additional_images.length > 0) {
                            property.additional_images.forEach(image => {
                                ...
                                thumbnail.className = 'w-20 h-20 flex-shrink-0 rounded overflow-hidden cursor-pointer border-2 border-transparent hover:border-primary';
                                thumbnail.innerHTML = `<img src="${image.path}" alt="${property.property_name}" class="w-full h-full object-cover">`;
